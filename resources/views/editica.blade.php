...
<div class="col-xs-12">
  <div class="box box-warning">
    ...
    <div class="iva-create box-body">
      <div class="iva-form">
        <form id="updateoneiva" name="updateoneiva" action="updateoneica" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group col-md-6 field-iva-nit_tercero required">
            ...
            <input type="text" id="iva-nit_tercero" class="form-control" name="nit_tercero" value="{{$ica->Nit}}" maxlength="255">
          ...
          <div class="form-group col-md-6 field-iva-nombre_tercero required">
            ...
            <input type="text" id="iva-nombre_tercero" value="{{$ica->Nombre}}" class="form-control" name="nombre_tercero" maxlength="255">
            <div class="help-block"></div>
          </div>
          <input type="hidden" value="{{$icaid}}" name="icaid">
          <div class="form-group col-md-6 field-iva-concepto required">
            <label class="control-label" for="iva-concepto">Concepto</label>
            <input type="text" id="iva-concepto" class="form-control" value="{{$ica->Concepto}}" name="concepto" maxlength="255">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-base_gravable required">
            ...
            <input type="text" id="iva-base_gravable" class="form-control" name="base_gravable" value="{{$ica->Base}}">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-porcentaje_retenido required">
            ...
            <input type="text" id="iva-porcentaje_retenido" class="form-control" name="porcentaje" value="{{$ica->Porcentaje}}">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-valor_retenido required">
            ...
            <input type="text" id="iva-valor_retenido" class="form-control" name="valor_retenido" value="{{$ica->Retenido}}">

            <div class="help-block"></div>
          </div>
          <div id="iva-anio" class="form-group col-md-6 field-iva-anio required">
            <label class="control-label" for="iva-anio">Año</label>
            <input type="text" id="iva-anio" class="form-control" name="anio" value="{{$ica->Ano}}">
            <div class="help-block"></div>
          </div>
          <div id="divperiodo" class="form-group col-md-6 field-iva-periodo required">
            ...
            <input type="text" id="iva-periodo" class="form-control" name="periodo" value="{{$ica->Periodo}}">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-ciudad_expedido required">
            ...
            <input type="text" id="iva-ciudad_expedido" class="form-control" name="ciudad_expedido" value="{{$ica->Ciudad_Expedido}}" maxlength="50">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-ciudad_pago required">
            ...
            <input type="text" id="iva-ciudad_pago" class="form-control" name="ciudad_pago" value="{{$ica->Ciudad_Pago}}" maxlength="50">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-fecha_expedicion required">
            <label class="control-label" for="iva-banco_pago">Empresa</label>
               <select class="form-control" id="pdesde" name="id_empresa" disabled="true">
                  <option value="{{$ica->id_empresa}}" selected="selected">{{$ica->nombre_empresa}}</option>
          ...
          <div class="form-group col-md-6 field-iva-fecha_expedicion required">
            ...
            <input type="text" id="iva-fecha_expedicion" class="form-control" name="fecha_expedicion" value="{{$ica->fecha_expedicion}}">
            <div class="help-block"></div>
          </div>
          @endforeach
