...
@section('content_header')
    <h1>Crear registro de IVA</h1>
    <ul class="breadcrumb">
    <li><a href="home">Inicio</a></li>
    <li><a href="iva-index">Editar Iva</a></li>
    <li class="active">Crear registro de IVA</li>
    </ul>
@stop
@section('content')
<div class="col-xs-12">
  <div class="box box-warning">
    ...
    <div class="iva-create box-body">
      <div class="iva-form">
        <form id="createoneiva" name="createoneiva" action="iva-create" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group col-md-6 field-iva-valor_iva required">
            ...
            <input type="text" id="iva-valor_iva" class="form-control" name="iva">
            <div class="help-block"></div>
          </div>
          ...
          <div class="form-group col-md-6 field-iva-ciudad_pago required">
            ...
            <input type="text" id="iva-ciudad_expedido" class="form-control" name="ciudad_pago" maxlength="50">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-fecha_expedicion required">
            ...
            <input type="text" id="iva-fecha_expedicion" class="form-control" name="banco_pago" value="">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-fecha_expedicion required">
            <label class="control-label" for="iva-fecha_expedicion">Fecha Expedición día/mes/año</label>
            <input type="text" id="iva-fecha_expedicion" class="form-control" name="fecha_expedicion" value="">
            <div class="help-block"></div>
          </div>
          <div class="form-group col-md-6 field-iva-fecha_expedicion required">
