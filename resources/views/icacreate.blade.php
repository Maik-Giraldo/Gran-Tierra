...
@section('content_header')
    <h1>Crear registro de ICA</h1>
    <ul class="breadcrumb">
    <li><a href="home">Inicio</a></li>
    <li><a href="ica-index">Ica</a></li>
    <li class="active">Crear registro de ICA</li>
    </ul>
@stop
@section('content')
<div class="col-xs-12">
  <div class="box box-warning">
    ...
    <div class="iva-create box-body">
      <div class="iva-form">
        <form id="updateoneica" name="createoneica" action="ica-create" method="post" enctype="multipart/form-data">
