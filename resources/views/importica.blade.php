...
@section('content_header')
    <h1>Importar certificados - ICA </h1>
    <ul class="breadcrumb"><li><a href="home">Inicio</a></li>
    <li class="active">Importar certificados - ICA </li>
    </ul>
@stop
...
<div class="box box-warning">
    <div class="iva-form box-body">
        <form id="icaimport" name="icaimport" action="upload-ica" method="post" enctype="multipart/form-data">
          ...
          @endif
                  ...
                  <div class="alert alert-success" role="alert">
                  Excelente! Se han subido satisfactoriamiente los certificados de Ica.<br>
              ...
              <select id="empresa" class="form-control" name="id_empresa" required>                
                ...
                <option value="todas">Todas</option>
                  @foreach($empresas as $empresa)
                    <option value="{{$empresa->id_empresa}}">{{$empresa->nit_empresa}} - {{$empresa->nombre_empresa}} - id {{$empresa->id_empresa}}</option>
                  @endforeach
              </select>
              <div class="help-block"></div>
            </div>
