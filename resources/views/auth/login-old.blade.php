		...
		<div class="col-md-7">
			...
			<div class="panel intro">
				...
				<div class="brand-wrapper">
					<img width="220" src="{{ asset('images/avon.png') }}" alt="certiweb" />
				</div>

				<h2>Bienvenido(a)</h2>
				<h4>Al Portal de proveedores de Avon.</h4>
				...
				<p>Si tiene dudas por favor comuníquese a la línea de atención (4) 356 7600 ext. 7847 o escribanos a departamento.impuestos@avon.com</p>
