...
@section('content_header')
    <h1>Importar accionista </h1>
    <ul class="breadcrumb"><li><a href="{{url('home')}}">Inicio</a></li>
    <li class="active">Importar accionista </li>
    </ul>
@stop
...
<div class="container">
     ...
     <br>
         ...
         <h3>Resultados de importación accionista:</h3>
         <br><br>
         ...
         <form id="deunr" name="accionistadeunr" action="accionistadeunr" method="post" enctype="multipart/form-data">
