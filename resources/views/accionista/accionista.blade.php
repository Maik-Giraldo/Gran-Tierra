          ...
          <div id="w0" class="grid-view">
            ...
            <table class="table table-striped table-bordered"><thead>
              ...
              <tr id="w0-filters" class="filters">
                <form role="search" class="navbar-form navbar-left" accept-charset="UTF-8" action="{{url('accionista-find')}}" method="GET">
                <td>&nbsp;</td>
                <td><input type="text" class="form-control" name="empresa"></td>
                <td></td>
                <td></td>
                <td><input type="number" class="form-control" name="anio" value=""></td>
                <td><input type="number" class="form-control" name="acciones" value=""></td>
                <td><input type="text" class="form-control" name="valor_nominal" value=""></td>
              ...
              <tr data-key="1016">
                ...
                <td>{{$accionista->Valor_Nominal}}</td>
