...
<div class="row">
    <div class="col-xs-12">
        ...
        <!-- /.tab-pane -->
            ...
            <a data-method="post" class="btn btn-success" href="/proveedor/update-status?id=29&status=Aprobado">Aprobado</a>
            <a data-method="post" class="btn btn-warning" href="/proveedor/update-status?id=29&status=En+proceso">En proceso</a>
            <a data-method="post" class="btn btn-danger" href="/proveedor/update-status?id=29&status=Declinado">Declinado</a>
