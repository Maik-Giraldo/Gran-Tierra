...
<div class="row">
    <div class="col-xs-12">  
        ...
        <div class="nav-tabs-custom">
            <p>
            <a class="btn btn-sm btn-primary" href="{{url('proveedores/update-id='.$proveedor->id)}}">Editar</a>
        </p>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                 ...
                                 {{$proveedor->nombre_razon_social}}                         </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
        ...
        <!-- /.tab-pane -->
            ...
            <a data-method="post" class="btn btn-success" href="/proveedor/update-id-{{$proveedor->id}}-status-Aprobado">Aprobado</a>
            <a data-method="post" class="btn btn-warning" href="/proveedor/update-id-{{$proveedor->id}}-status-EnProceso">En proceso</a>
            <a data-method="post" class="btn btn-danger" href="/proveedor/update-id-{{$proveedor->id}}-status-Declinado">Declinado</a>
