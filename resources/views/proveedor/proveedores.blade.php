  ...
  <div class="proveedores-index box-body">
    ...
    <table class="table table-striped table-bordered"><thead>
      ...
      <tr id="w0-filters" class="filters">
        <form role="search" class="navbar-form navbar-left" accept-charset="UTF-8" action="proveedores/search" method="GET">
...
<tr data-key="29">
  ...
  <td><a href="proveedores/view-id={{$proveedor->id}}" title="Ver" aria-label="Ver" data-pjax="0">{{$proveedor->numero_nit_cc}}</a></td>
  <td>{{$proveedor->digito_verificacion}}</td>
  <td>{{$proveedor->email}}</td>
  <td>{{$proveedor->estado}}</td>
  <td><a href="proveedores/view-id={{$proveedor->id}}" title="Ver" aria-label="Ver" data-pjax="0">
    <span class="glyphicon glyphicon-eye-open"></span></a>
    <a href="proveedores/update-id={{$proveedor->id}}" title="Actualizar" aria-label="Actualizar" data-pjax="0">
