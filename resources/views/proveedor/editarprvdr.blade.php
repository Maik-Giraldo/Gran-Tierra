...
@section('content_header')
    ...
    <ul class="breadcrumb"><li><a href="/">Inicio</a></li>
      <li><a href="../proveedores">Provider</a></li>
    <li class="active">Edit providerr</li>
    </ul>
@stop
...
<label class="control-label" for="proveedor-nombre_razon_social">Nombre Empresa</label>
...
<label class="control-label" for="proveedor-numero_nit_cc">N° Identificación.</label>
...
<label class="control-label" for="proveedor-telefono">N° Celular</label>
...
<label class="control-label" for="proveedor-codigo_ciiu">Código Ciudad</label>
