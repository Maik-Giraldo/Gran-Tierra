    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <textarea class="form-control" rows="5" id="comment" name="bienes" required></textarea>
        </div>
      </div>
    </div>
    <div class="row">
...
<input type="number" id="proveedor-ciudad" required class="form-control" name="valor_total" placeholder="$" value="" maxlength="60">
...
<div class="help-block"></div>
        ...
        <!-- /.tab-pane -->
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success center-block">Generar Documento Soporte</button>
            </div>
        </form>
            <!-- /.tab-content -->
    </div>
