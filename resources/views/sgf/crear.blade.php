...
<div class="box box-warning">
    ...
    <div class="seguimiento-facturas-form">
      <form id="csgfcts" action="{{url('seguimiento-facturas/create')}}" method="post">
        ...
        <div class="form-group field-seguimientofacturas-reteiva required">
          <label class="control-label" for="seguimientofacturas-reteiva">RETEIVA</label>
          <input type="number" id="seguimientofacturas-reteiva" class="form-control" name="reteiva">
          <div class="help-block"></div>
        </div>
        <div class="form-group field-seguimientofacturas-valor_neto required">
        ...
        <div class="form-group field-seguimientofacturas-fecha_importacion required">
          <label class="control-label" for="seguimientofacturas-fecha_pago">Fecha del Pago</label>
          <input type="date" id="seguimientofacturas-fecha_pago" class="form-control" name="fecha_pago">
          <div class="help-block"></div>
        </div>
        <div class="form-group field-seguimientofacturas-nit required">
          <label class="control-label" for="seguimientofacturas-nit">Banco Receptor</label>
          <input type="text" id="seguimientofacturas-namepr" class="form-control" name="banco_receptor" maxlength="255">
          <div class="help-block"></div>
        </div>
        <div class="form-group field-seguimientofacturas-nit required">
          <label class="control-label" for="seguimientofacturas-nit">Cuenta Bancaría #</label>
          <input type="text" id="seguimientofacturas-namepr" class="form-control" name="cuenta_bancaria" maxlength="255">
          <div class="help-block"></div>
        </div>
        ...
        <div class="form-group field-seguimientofacturas-texto required">
          ...
          <input type="text" id="seguimientofacturas-texto" class="form-control" name="texto" maxlength="250">
          <div class="help-block"></div>
        </div>
