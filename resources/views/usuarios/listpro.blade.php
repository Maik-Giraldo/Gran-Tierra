              ...
              <div class="form-inline pull-right">
                <span style="display: none" id="user-grid-clear-filters-btn" class="btn btn-sm btn-default">
                  ...
                  <select class="form-control input-sm" name="grid-page-size" id="grid-page-size">
                    <option value="{{url('usuarios/proveedores-list/'.$usuarios->perpage())}}" selected>{{$usuarios->perpage()}}</option>
                    <option value="{{url('usuarios/proveedores-list/5')}}">5</option>
                    <option value="{{url('usuarios/proveedores-list/10')}}">10</option>
                    <option value="{{url('usuarios/proveedores-list/20')}}">20</option>
                    <option value="{{url('usuarios/proveedores-list/50')}}">50</option>
                    <option value="{{url('usuarios/proveedores-list/100')}}">100</option>
                    <option value="{{url('usuarios/proveedores-list/200')}}">200</option>
                  </select>
                </div>
      				</div>
            </div>
              ...
              <thead>
                ...
                <tr id="user-grid-filters" class="filters">
                  ...
                  <td>
                      <select class="form-control" name="gridRoleSearch" id="gridRoleSearch">
                        ...
                        <option value="{{url('usuarios/20')}}">Todos</option>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-sm btn-primary" href="#" data-pjax="0">Roles y permisos</a></td>
                    <td><a class="btn btn-sm btn-default" href="#" data-pjax="0">Cambiar contraseña de usuario</a></td>
                    <td style="text-align:center; width:80px; white-space:nowrap;">
                      @if ($usuario->activo == '1')
                    ...
                    <td style="width:70px; text-align:center;"><a href="#" title="Ver" aria-label="Ver">
                      <span class="glyphicon glyphicon-eye-open"></span></a>
                     <a href="#" title="Actualizar" aria-label="Actualizar" data-pjax="0">
                       <span class="glyphicon glyphicon-pencil"></span></a>
                     <a href="#" title="Eliminar" aria-label="Eliminar">
