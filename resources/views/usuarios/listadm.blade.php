              ...
              <div class="form-inline pull-right">
                <span style="display: none" id="user-grid-clear-filters-btn" class="btn btn-sm btn-default">
                  ...
                  <select class="form-control input-sm" name="grid-page-size" id="grid-page-size">
                    <option value="{{url('usuarios/administradores-list/'.$usuarios->perpage())}}" selected>{{$usuarios->perpage()}}</option>
                    <option value="{{url('usuarios/administradores-list/5')}}">5</option>
                    <option value="{{url('usuarios/administradores-list/10')}}">10</option>
                    <option value="{{url('usuarios/administradores-list/20')}}">20</option>
                    <option value="{{url('usuarios/administradores-list/50')}}">50</option>
                    <option value="{{url('usuarios/administradores-list/100')}}">100</option>
                    <option value="{{url('usuarios/administradores-list/200')}}">200</option>
                  </select>
                </div>
      				</div>
            </div>
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$usuario->id}}</td>
                    <td><a href="/view/id=3">{{$usuario->Nit}}</a></td>
                    <td>{{$usuario->email}}</td>
