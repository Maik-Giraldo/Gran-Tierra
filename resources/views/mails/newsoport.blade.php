...
<center style="width: 100%; background: #f9f9f9; text-align: left;">
   ...
   <div style="max-width: 620px; margin: auto;" class="email-container">
       ...
       <table class="container" role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 620px;">
           ...
           <tr>
               <td bgcolor="#ffffff">
                   <img src="https://certificadoscolombia.com/public/images/Demo.png" aria-hidden="true" width="620" height="228" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 620px; height: auto; background: #f9f9f9; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
               </td>
           </tr>
           <!-- Banner Image: END -->
                   ...
                   <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                       <tr>
                           <td class="header-td" style="padding:40px 60px 30px 40px; font-family: 'Poppins', sans-serif;">
                               ...
                               Nuevo mensaje de soporte.</a></h3> <br>
                               <p class="header-p" style="margin: 0; font-size: 14px;">
                               <strong>Usuario: {{$name}},<br>
                               <strong>Tema:</strong> {{$subject}},<br>
                               <strong>Pregunta:</strong> {{$body}},<br>
