                   ...
                   <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                       <tr>
                           <td class="header-td" style="padding:40px 60px 30px 40px; font-family: 'Poppins', sans-serif;">
                             ...
                             Hola {{$Empresa}} ya se encuentra activado en la plataforma para los proveedores del grupo Demo.</a></h3> <br>
                             Ya puede ingresar a proveedoresDemo.com con los datos de acceso registrados previamente.
                             <p class="header-p" style="margin: 0; font-size: 14px;">
                             <strong>Usuario: {{$Nit}} </strong><br>
                             <strong>Contraseña: La registrada previamente </strong>,<br>
                             Cordialmente,
