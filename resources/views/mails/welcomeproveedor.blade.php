                   ...
                   <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                       <tr>
                           <td class="header-td" style="padding:40px 60px 30px 40px; font-family: 'Poppins', sans-serif;">
                               ...
                               Hola {{$name}} Bienvenido(a) a la plataforma dedicada especialmente para los proveedores del grupo Demo</a></h3> <br>
                               Recibirá en el transcurso de 72 horas un correo con la activación de su usuario en proveedoresDemo.com
