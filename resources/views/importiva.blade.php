...
@section('content_header')
    <h1>Importar certificados - IVA </h1>
    <ul class="breadcrumb"><li><a href="home">Inicio</a></li>
    <li class="active">Importar certificados - IVA </li>
    </ul>
@stop
...
<div class="box box-warning">
    <div class="iva-form box-body">
        <form id="ivaimport" name="ivaimport" action="upload-iva" method="post" enctype="multipart/form-data">
