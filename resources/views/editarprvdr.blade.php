...
<label class="control-label" for="proveedor-persona_autoriza">Persona Autorizada por Mercacentro</label>
...
<option value="{{$proveedor->estado}}" selected>{{$proveedor->estado}}</option>
