 ...
 <div class="container">
   <div class="row">
     <div class="col-sm-12 col-md-10 col-md-offset-1">
       <form method="POST" action="uploadrtf" accept-charset="UTF-8" id="uploadrtf" name="uploadrtf" enctype="multipart/form-data">
        ...
        @endif
          ...
          <span>Subir archivo excel de RTF</span>
          <br>
        ...
        <div class="col-sm-offset-4 col-sm-3 text-center">
          <input class="btn btn-success btn-block btn-lg" value="Subir Rtf" type="submit">
        </div>
      </form>
    </div>
 </div>
